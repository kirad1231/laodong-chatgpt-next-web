...
## ¿Cuál es la diferencia entre los modelos gpt-4o-mini y GPT3.5-TURBO-0301 (o GPT3.5-TURBO-MMDD)?

Descripción de la documentación oficial: https://platform.openai.com/docs/models/gpt-3-5

*   gpt-4o-mini es el último modelo y se actualiza constantemente.
*   gpt-4o-mini-0301 es una instantánea del modelo congelada el 1 de marzo, no cambiará y se espera que sea reemplazada por una nueva instantánea en 3 meses.
